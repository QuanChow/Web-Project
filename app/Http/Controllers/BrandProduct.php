...
class BrandProduct extends Controller
{
    ...
    public function unactive_brand_product($brand_product_id){
        ...
        Session::put('message','Thay Đổi Hiển Thị Thương Hiệu Thành Công');
    ...
    public function edit_brand_product($brand_product_id){
        ...
        $manager_brand_produtct = view('admin.edit_brand_product')->with('edit_brand_product',$edit_brand_product);
        return view('admin_layout')->with('admin.edit_brand_product',$manager_brand_produtct);
    }
